    ...
    class Program
    {
        ...
        static void dos_start() {
            ...
            while (blivVedogved) {
                ...
                Console.Write(">");
                //Added a Readkey to read the input given by the user and using Parse to convert the string into an int32.
        ...
        */
        ...
        {
            datafil = "bank.json"; //Changed name on file to get the full access of the json file.
